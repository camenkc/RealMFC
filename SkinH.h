...
extern "C"
{
	...
	/*	返回值: 成功返回0, 失败返回非0										*/
	/************************************************************************/
	DECLSKINHAPI SkinH_AttachEx(LPCTSTR strSkinFile,	LPCTSTR strPassword		);
//皮肤文件路径//皮肤密钥

	/*
		功能:	加载指定路径的皮肤进行换肤并指定相应的色调，饱和度，亮度
		返回值: 成功返回0, 失败返回非0
	*///皮肤文件路径//皮肤密钥	//色调，	取值范围-180-180, 默认值0//饱和度，	取值范围-100-100, 默认值0//亮度，	取值范围-100-100, 默认值0
	DECLSKINHAPI SkinH_AttachExt(LPCTSTR strSkinFile,	LPCTSTR strPassword,	int nHue,int nSat,int nBri);
